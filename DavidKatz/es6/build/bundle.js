...
/***/ function(module, exports, __webpack_require__) {
	...
	var api_key = '082cbb8db47b5c95ae1fe6fe92ba44ca';
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'grabWeather',
	    value: function grabWeather(city) {
	      var _this2 = this;

	      /*
	      Promise -handles the eventual result of an event / function
	      */
	      fetch('http://api.openweathermap.org/data/2.5/weather?APPID=' + api_key + '&q=' + city).then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        return _this2.setState({ description: json.weather[0].description });
	      });
	    }
	  }, {
	    key: 'render',
